  ...
  >
    ...
    >
      <div class="flex flex-col items-center gap-3" data-aos="zoom-in">
        ...
        <div
          class="font-main font-black text-lg md:text-xl uppercase tracking-widest border-[3px] border-accent px-6 py-2 bg-white shadow-[6px_6px_0_0_#2C3E50] rotate-[-2deg] mt-1"
        >
          Protect Your Assets
        </div>
      </div>
      ...
      >
        <p
          class="font-pixel text-[10px] md:text-xs tracking-widest uppercase opacity-80 text-center leading-loose"
        >
