    ...
    <nav :class="[
      ...
      <div class="flex items-center px-6 md:px-8 h-full">
        <router-link to="/"
          ...
          <img :src="Logo" alt="Fundivest Logo" class="h-10 md:h-12 w-auto object-contain" />
          <span class="font-pixel text-xl md:text-1xl tracking-tighter uppercase whitespace-nowrap">
            FUNDIVEST
          </span>
        </router-link>
      </div>
